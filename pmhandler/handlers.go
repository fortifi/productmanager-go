...
func (h *Handler) SetAvailabilityCheckHandler(handler func(*request.AvailabilityCheck) (response.Availability, error)) {
	h.handlers.availabilityCheck = handler
}
func (h *Handler) SetAvailabilityReserveHandler(handler func(*request.AvailabilityReserve) (response.Availability, error)) {
...
type handlers struct {
	availabilityCheck      func(*request.AvailabilityCheck) (response.Availability, error)
	availabilityReserve    func(*request.AvailabilityReserve) (response.Availability, error)
